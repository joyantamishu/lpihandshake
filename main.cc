...
//	}
	...
	fp_host_utilization = fopen ("host_utilization_madhurima.csv","w");
	...
	FILE *fp_copy;
	fp_copy = fopen ("copy_create_delete.csv","w");
	fprintf(fp_copy,"time,create/delete,chunk_number,source,destination,number_of_copy_creation_packet,ssd_no_at_destination\n");
	fclose(fp_copy);
